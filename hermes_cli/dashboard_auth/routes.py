...
def _client_ip(request: Request) -> str:
    # Delegates to the shared trusted-proxy-aware resolver so the login rate
    # limiter never keys on a spoofable X-Forwarded-For unless
    # dashboard.trusted_proxy is set. See client_ip.py.
